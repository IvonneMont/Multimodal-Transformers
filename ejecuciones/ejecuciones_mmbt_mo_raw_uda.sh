/002/usuarios/ivonne.monter/anaconda3/envs/p38C/bin/python train.py --batch_sz 4 --gradient_accumulation_steps 32 \
 --savedir checkpoints3/ --name  mmbt_uda_randa_2_512_3_ap_grad  --type train --modality ti\
 --data_path data_sets/proc/ \
 --task moviescope --task_type multilabel \
 --model mmbt --uda 1 --num_image_embeds 3 --img_hidden_sz 2048 --encoder Resnet152 --poster raw --aug 0 --type_aug randa\
 --tuning_metric miap \
